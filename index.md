...
venue: "Lancaster University" # brief name of host site without address (e.g., "Euphoric State University")
address: "Bowland Hall, Bailrigg, Lancaster LA1 4ZA" # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latitude: "54.0118097" # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-2.7872807" # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Feb 20-21, 2020"  # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 5:00 pm" # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2020-02-21 # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2020-02-22   # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Alexander Konovalov (University of St Andrews)", "Samuel Lelièvre (Université Paris-Sud)", "Fredrik Strömberg (University of Nottingham)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes: https://pad.carpentries.org/2020-02-20-lancaster # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<strong>This workshop is brought to you by
